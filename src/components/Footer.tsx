        ...
        <div>
          ...
          <div className="mt-3 space-y-2 text-foreground/80">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="https://instagram.com/besafehealthtr" target="_blank" rel="noreferrer" className="hover:text-[var(--color-gold-400)] transition-colors duration-200 cursor-pointer">Instagram</a>
            </div>
          </div>
        </div>
      </div>
